"""Vendored from TechnicalAnalysisAutomation (MIT) with import path tweaks only."""
...
if __name__ == '__main__':
    ...
    # Load data
    data = pd.read_csv('C:/Users/kiluh/OneDrive/Desktop/GoldenEggBot/src/strategies/data_samples/BTCUSDT86400.csv')
