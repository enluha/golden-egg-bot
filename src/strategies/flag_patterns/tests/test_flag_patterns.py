...
from src.strategies.flag_patterns.upstream.flags_pennants import (
    find_flags_pennants_pips,
    find_flags_pennants_trendline,
)


DATA_PATH = Path(__file__).resolve().parents[2] / "data_samples" / "BTCUSDT3600_Jun2024_Oct2025.csv"
